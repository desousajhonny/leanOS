...
- Product Strategist: `roles/product-strategist.role.md` - use when strategy is unclear; ICP or value proposition needs definition; roadmap coherence is at risk.
- Product Manager: `roles/product-manager.role.md` - use when scope needs definition; roadmap work needs issue-ready shape; acceptance criteria are missing.
