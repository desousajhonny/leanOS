...
- Product Strategist: `roles/product-strategist.role.md` - use when strategy is unclear; ICP or value proposition needs definition; MVP validation scope needs definition; roadmap coherence is at risk.
