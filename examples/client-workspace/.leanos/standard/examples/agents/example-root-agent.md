...
- Começo, retomada ou calibração de ideia: `clinic-assistant-ai-os/strategy/AGENT.md`, depois Strategy Product e `idea-calibration.playbook.md`.
...
- Setup ou retomada do LeanOS: `clinic-assistant-ai-os/strategy/AGENT.md` -> Strategy Product -> `idea-calibration.playbook.md`
