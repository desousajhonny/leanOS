# Define Company Skill

## Purpose

Clarify company context, mission, principles and operating model.
...
This skill belongs to the Product department. Do not use it as a global skill without routing through the department first.
