# Create Interview Script Skill

## Purpose

Write discovery questions that reduce bias.
...
This skill belongs to the Validation department. Do not use it as a global skill without routing through the department first.
