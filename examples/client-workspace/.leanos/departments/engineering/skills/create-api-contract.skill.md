# Create API Contract Skill

## Purpose

Define API inputs, outputs, errors and ownership boundaries.
...
This skill belongs to the Engineering department. Do not use it as a global skill without routing through the department first.
