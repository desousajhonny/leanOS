# Create Landing Page Copy Skill

## Purpose

Draft clear copy for the first validation or launch page.
...
This skill belongs to the Growth department. Do not use it as a global skill without routing through the department first.
