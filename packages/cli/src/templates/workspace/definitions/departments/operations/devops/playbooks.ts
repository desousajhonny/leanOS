...
export const operationsDevopsPlaybooks: PlaybookDefinition[] = [
    ...
    },
    {
      ...
      outputs: ["Resumo de prontidão do GitHub", "Configuração ausente", "Founder-friendly setup instructions", "Proposed project-sync.yaml updates", "Proposed labels.yaml updates", "Orientação de fonte de token without token values", "Vercel readiness notes", "Próxima ação para sync de Epics/Features no GitHub"],
