...
export const operationsDevopsRoles: RoleDefinition[] = [
    {
      ...
      skills: ["configure-environments", "setup-ci", "branch-protection", "plan-deployment", "define-observability", "prepare-release"],
      playbooks: ["setup-ci-cd", "github-safety-baseline", "plan-deployment", "configure-github-project", "configure-environments", "define-observability", "release-operations"]
    },
    {
      slug: "github-devops",
      title: "GitHub DevOps",
      ...
      beforeActing: ["../AGENT.md", "../knowledge/github-management.md", "../../../README.md", "Strategy Product -> Product Narrative Editor -> write-product-readme", ".github/leanos/setup-guide.md", ".github/leanos/capability-contract.md", ".github/leanos/github-settings.example.json", ".github/leanos/project-sync.yaml", ".github/leanos/sync-state.yaml", ".github/leanos/labels.yaml", "../skills/repository-profile/SKILL.md", "../skills/branch-protection/SKILL.md", "../playbooks/github-safety-baseline.playbook.md"],
