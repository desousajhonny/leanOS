...
export const operationsEngineeringSkills: SkillDefinition[] = [
    {
      ...
      requiredContext: ["Corpo da Feature ou da issue do GitHub mapeada", "PRD", "Escopo do MVP", "Critérios de aceite", "Regras de implementação de Engineering", "Padrões de código"],
      inputs: ["Feature", "Epic ou PRD vinculado", "Critérios de aceite", "Padrões atuais do repositório", "Riscos conhecidos"],
      process: ["Resuma a Feature no chat", "Identifique arquivos ou módulos provavelmente envolvidos", "Classifique impacto de Design, Security e dados", "Planeje os menores passos seguros de implementação", "Identifique testes e validação", "Peça confirmação antes de alterar código quando o escopo estiver incerto"],
      checks: ["O plano de implementação permanece dentro do escopo da Feature", "Padrões existentes do repositório são preferidos", "Dependências e riscos estão explícitos", "O roteamento para Design/Security/Data está explícito quando aplicável"],
      ...
      redLines: ["Não comece mudanças de código sem contexto de branch", "Não expanda escopo silenciosamente", "Não pule classificação de Design/Security/Data."]
    },
    {
    ...
    },
    {
      ...
      requiredContext: ["Feature ou issue de Feature no GitHub", "Especificação de componente de Design", "Inventário de componentes de Design", "Design system", "Baseline de acessibilidade", "Diretrizes de componentes de Engineering", "Padrões de código", "Estratégia de testes"],
      ...
      process: ["Leia a Feature e confirme por que o componente é necessário", "Leia a especificação de componente de Design antes de alterar código", "Verifique `../../design/knowledge/component-inventory.md` e código próximo para encontrar componente reutilizável existente", "Carregue `../../design/knowledge/design-system.md`, `../../design/knowledge/accessibility.md` e `../knowledge/component-guidelines.md`", "Implemente o componente reutilizável antes da tela ou Feature que o consome", "Mantenha estilo, copy, variantes, estados e acessibilidade alinhados ao contrato de Design", "Separe comportamento reutilizável do componente da lógica pontual da tela", "Adicione testes, exemplos, stories ou notas de validação manual quando o repositório suportar"],
      checks: ["O componente segue a especificação de Design", "Design tokens e requisitos de acessibilidade são respeitados", "Não existe componente duplicado", "O componente é reutilizável e componível", "Estados obrigatórios são tratados", "Lógica de fluxo específica da Feature fica fora do componente reutilizável", "Testes ou lacunas de validação estão explícitos"],
    ...
    },
    {
      ...
      useWhen: ["a implementação está prestes a começar", "uma Feature local ou issue do GitHub mapeada foi selecionada", "o nome da branch precisa de validação"],
      requiredContext: ["Slug da Feature local ou número da issue do GitHub", "Título da Feature", "Regras de branch"],
      inputs: ["Slug da Feature ou número da issue", "Título da Feature", "Tipo de branch", "Nomes de branch existentes quando disponíveis"],
      process: ["Carregue as regras de branch", "Gere um nome de branch vinculado à Feature", "Use `feature/...` para Features apenas locais e `issue/...` para issues do GitHub mapeadas", "Mantenha o nome da branch curto e descritivo", "Verifique conflitos com nomes de branch existentes", "Peça confirmação antes de reutilizar ou substituir uma branch"],
      checks: ["A branch inclui o número da issue quando disponível", "A branch usa o slug da Feature quando não há número de issue", "O nome da branch não inclui segredos nem termos vagos", "A branch segue a convenção do repositório"],
    ...
    },
    {
      ...
      requiredContext: ["Template de PR", "Issue vinculada", "Notas de implementação", "Testes executados", "Riscos conhecidos", "Requisitos do Founder Testing Guide"],
      inputs: ["Branch", "Issue vinculada", "Arquivos alterados", "Testes", "Riscos", "Screenshots ou notas de UX quando aplicável", "URL de preview ou rota local quando disponível"],
      process: ["Confirme a Feature local ou issue do GitHub vinculada e a branch atual", "Carregue o template de PR", "Resuma escopo, não objetivos e notas de implementação", "Liste arquivos alterados que importam para revisão", "Inclua testes executados, validação manual e explicação de lacuna de teste", "Escreva o Founder Testing Guide em linguagem simples com onde testar, como testar e resultado esperado", "Sinalize aplicabilidade de Design/Security/Data/DevOps", "Marque o status de prontidão do PR como draft, founder-ready, blocked-by-tests ou blocked-by-context", "Liste riscos conhecidos e follow-up"],
      checks: ["O PR referencia a issue ou Feature local", "Testes executados ou explicação de lacuna de teste estão presentes", "O Founder Testing Guide é usável por um founder não técnico", "Aplicabilidade de Design/Security/Data/DevOps está explícita quando relevante", "A descrição não esconde risco conhecido"],
      outputs: ["Título do PR", "Corpo do PR", "Founder Testing Guide", "Resumo de testes", "Status de prontidão do PR", "Notas de risco"],
