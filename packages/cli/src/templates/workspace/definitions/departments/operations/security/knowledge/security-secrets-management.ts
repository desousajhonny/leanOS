...
export function securitySecretsManagementKnowledge(): string {
  return securityKnowledge(
    ...
    ["Fontes de segredo for local, preview/staging and production.", "Who can access secrets.", "Rotation triggers.", "Leak response steps.", "CI/CD secret usage."],
    ...
    ["Nenhum segredo em Git, logs, prompts, screenshots ou arquivos versionados.", "No token pasted into chat.", "No secret copied into documentation.", "No broad token when scoped token is enough."],
