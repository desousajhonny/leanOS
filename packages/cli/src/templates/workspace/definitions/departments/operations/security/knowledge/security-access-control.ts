...
export function securityAccessControlKnowledge(): string {
  return securityKnowledge(
    ...
    ["Nunca confie em userId, tenantId, role ou isAdmin vindos do cliente.", "No private endpoint without server-side authorization.", "No admin route without explicit RBAC and audit trail.", "No broad service account for user-level actions."],
