...
export const strategyRoadmapPlaybooks: PlaybookDefinition[] = [
    {
      ...
      useWhen: ["o produto já opera com múltiplas prioridades e precisa escolher Now/Next/Later", "o founder pede para sequenciar roadmap, backlog ou ciclo atual sem virar implementação imediata", "sinais de cliente, validação ou restrições operacionais precisam mudar a ordem do roadmap"],
