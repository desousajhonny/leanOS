...
export const strategyProductFiles: AreaFileDefinition[] = [
    { path: "knowledge/README.md", content: () => folderReadme("Product Knowledge", "Contexto durável de produto produzido por Strategy Product.", "Use ao definir estratégia de produto, Product Core, ICP, proposta de valor, MVP Validation Scope, posicionamento, notas leves de validação ou coerência de produto.", "brief.md", ["brief.md", "problem.md", "icp.md", "jobs-to-be-done.md", "value-proposition.md", "positioning.md", "mvp-validation-scope.md", "validation-notes.md"], ["../roles/", "../skills/", "../playbooks/", "../../business/", "../../roadmap/"], "Mantenha contexto de empresa/produto aqui. Não enriqueça roles, skills ou playbooks com fatos específicos da empresa.") },
