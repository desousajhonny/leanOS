...
export const growthCustomerExperiencePlaybooks: PlaybookDefinition[] = [
    {
      ...
      useWhen: ["feedback, suporte, churn ou momentos de sucesso precisam virar aprendizado acionável", "Marketing, Product Ops ou Strategy precisa de sinais de cliente antes de decidir próximo ciclo", "o founder quer entender padrões de atendimento sem criar processo pesado de CX"],
