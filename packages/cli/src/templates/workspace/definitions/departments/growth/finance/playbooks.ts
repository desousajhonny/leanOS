...
export const growthFinancePlaybooks: PlaybookDefinition[] = [
    ...
    },
    {
      ...
      steps: ["Leia o AGENT de Finance e escolha Finance Operator", "Carregue `../knowledge/spend-ledger.md` e `../knowledge/budget.md`", "Use `skills/review-spend/SKILL.md` para classificar categoria, owner, período e impacto", "Use `skills/runway-check/SKILL.md` quando o gasto afetar burn ou runway", "Classifique decisão como spend_approved, spend_rejected, spend_paused, needs-founder-confirmation ou needs-more-context", "Liste automações candidatas como alerta de custo, usage cap ou reminder de renovação", "Peça confirmação antes de atualizar arquivos"],
    ...
    },
    {
      ...
      steps: ["Leia o AGENT de Finance e escolha Finance Operator", "Carregue `../knowledge/spend-ledger.md`, `../knowledge/budget.md`, `../knowledge/unit-economics.md` e `../knowledge/finance-risks.md`", "Agrupe gastos por categoria, status e owner", "Estime monthly burn separando conhecido, estimado e unknown", "Use `skills/runway-check/SKILL.md` para revisar runway quando houver dados suficientes", "Identifique gastos sem owner, sem uso claro, sem data de revisão ou com custo variável crescente", "Recomende pausar, manter, revisar, renegociar, automatizar alerta ou pedir decisão do founder"],
