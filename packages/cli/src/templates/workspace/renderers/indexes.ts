...
function intentMap() {
  return {
    ...
    intents: {
      ...
      product_analytics: {
        signals: ["analytics", "telemetria", "eventos", "tracking", "funil", "UTM", "origem do lead", "conversão", "resultado de experimento"],
        owner_department: "operations",
        required_areas: ["operations.product-analytics"],
        activation_required: "operations.product-analytics",
        expected_chain: {
          area: "operations.product-analytics",
      ...
      external_integrations: {
        signals: ["API externa", "webhook", "integração", "provider", "retry", "idempotência", "payload", "OAuth", "API key", "logs de integração"],
        owner_department: "operations",
        required_areas: ["operations.external-integrations"],
        activation_required: "operations.external-integrations",
        expected_chain: {
          area: "operations.external-integrations",
